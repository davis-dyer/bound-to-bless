...
import { getAllBibleItems, saveItem } from '../utils/firebaseFunctions';
    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
          <BiBible className='text-xl text-gray-700' />
          <input 
            type="text" 
            required 
            value={title}
        ...
        <div className="w-full">
          <select onChange={(e) => setCategory(e.target.value)} className='outline-none w-full text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'>
            ...
            {categories && categories.map(item => (
              <option 
                key={item.id} className='text-base border-0 outline-none capitalize bg-white text-headingColor'
        ...
        <div className='w-full flex flex-col md:flex-row items-center gap-3'>
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
            <IoMdPricetag className='text-gray-700 text-2xl' />
            <input 
              type="text" 
              required
              value={price}
          ...
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
            <GiBookCover className='text-gray-700 text-2xl' />
            <input 
              type="text" 
              required
              value={condition}
